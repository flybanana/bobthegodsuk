...
/**
 * Created by missionbit on 6/26/18.
 */

public class Flyingdog {
    ...
    public Flyingdog(SpriteBatch batch) {
        myBatch = batch;
        myImage = new Sprite(new Texture(Gdx.files.internal("image/ob.png")));
        effect = new ParticleEffect();
        effect.load(Gdx.files.internal("effects/bobthegodsuk"), Gdx.files.internal("image"));
